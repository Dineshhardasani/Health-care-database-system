...
<form method="GET" >
  ...
  if(isset($_GET['submit'])){
    ...
    $query="SELECT r.patient_id,r.doctor_id,r.date,r.discharge_date,p.first_name as patient_name ,d.first_name as doctor_name from records r,patient p,doctor d where r.patient_id=p.patient_id
    AND r.doctor_id=d.doctor_id AND r.patient_id='$_GET[id]' AND p.first_name='$_GET[name]'";
